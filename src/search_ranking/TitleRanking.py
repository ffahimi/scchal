                    ...
                    for index_one in term_one_indexes:
                        for index_two in term_two_indexes:
                            if index_one < index_two:
                                title_substring = title[index_one:index_two + len(self.search_terms[j])]
                                #if order is following the order of search terms
                                order = 0
                            else:
                                title_substring = title[index_two:index_one + len(self.search_terms[i])]
                        ...
                        if not compound_match:
                            ...
                            title_rank -= 1.0*len(self.search_terms)
